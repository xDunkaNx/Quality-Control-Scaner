    ...
    <body class="font-sans antialiased">
        <div class="bg-gray-100">
                    ...
                    @endcan
                        ...
                        <div class="relative text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">
                            ...
                            <div class="absolute right-0 w-48 mt-2 origin-top-right bg-white shadow-lg rounded-md hidden" id="user-dropdown">
                                ...
                                <a class="block px-4 py-2 text-sm text-gray-700">Perfil</a>
            ...
            @endcan
                    ...
                    <a method="POST" href="{{ route('logout') }}" class="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">Cerrar sesión</a>
                </div>
            </div>
        </div>
